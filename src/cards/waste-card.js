...
const DEFAULT_TILES_TITLE = 'nächste abholungen';
...
export class TerminalWasteCard extends WasteCalendarCardBase {
  ...
  constructor() {
    ...
    this._expand.setAttribute('aria-controls', 'terminal-waste-tiles');
    ...
    this._tilesFrame.id = 'terminal-waste-tiles';
    this._tilesFrame.className = 'tiles-frame';
    this._tilesFrame.setAttribute('role', 'region');
    this._tilesFrame.setAttribute('aria-labelledby', 'terminal-waste-tiles-title');
    this._tilesTitle = document.createElement('div');
    this._tilesTitle.id = 'terminal-waste-tiles-title';
